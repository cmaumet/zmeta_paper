...
A growing literature is focusing on the lack of statistical power in neuroimaging studies (see, e.g.~\cite{Button2013}), feeding the debate on the validity and reproducibility of published neuroimaging results. Meta-analysis, by providing inference based on the results of previously conducted studies, provides an essential method to increase power and hence confidence in results. Functional Magnetic Resonance Imaging (fMRI), with its ample literature of more than 100 000 articles [ADDREF] is particularly well-suited for this approach. -- use mature field with robust well-established methods
